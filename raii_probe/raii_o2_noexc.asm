...
raii_probe/raii_o2_noexc:     file format elf64-x86-64
...
00000000004010a0 <__isoc23_strtol@plt>:
  ...
  4010a4:	ff 25 66 2f 00 00    	jmp    QWORD PTR [rip+0x2f66]        # 404010 <__isoc23_strtol@GLIBC_2.38>
  4010aa:	66 0f 1f 44 00 00    	nop    WORD PTR [rax+rax*1+0x0]

00000000004010b0 <malloc@plt>:
  4010b0:	f3 0f 1e fa          	endbr64
  4010b4:	ff 25 5e 2f 00 00    	jmp    QWORD PTR [rip+0x2f5e]        # 404018 <malloc@GLIBC_2.2.5>
  4010ba:	66 0f 1f 44 00 00    	nop    WORD PTR [rax+rax*1+0x0]

00000000004010c0 <fopen@plt>:
  4010c0:	f3 0f 1e fa          	endbr64
  4010c4:	ff 25 56 2f 00 00    	jmp    QWORD PTR [rip+0x2f56]        # 404020 <fopen@GLIBC_2.2.5>
...
00000000004010d0 <main>:
  ...
  4010d7:	7f 08                	jg     4010e1 <main+0x11>
  4010d9:	83 cf ff             	or     edi,0xffffffff
  4010dc:	e9 0f 01 00 00       	jmp    4011f0 <probe(int)>
  4010e1:	50                   	push   rax
  ...
  4010f5:	e9 f6 00 00 00       	jmp    4011f0 <probe(int)>
...
0000000000401100 <_start>:
  ...
  40111f:	ff 15 b3 2e 00 00    	call   QWORD PTR [rip+0x2eb3]        # 403fd8 <__libc_start_main@GLIBC_2.34>
  401125:	f4                   	hlt
...
00000000004011b0 <__do_global_dtors_aux>:
  ...
  4011b4:	80 3d 7d 2e 00 00 00 	cmp    BYTE PTR [rip+0x2e7d],0x0        # 404038 <__TMC_END__>
  ...
  4011c6:	c6 05 6b 2e 00 00 01 	mov    BYTE PTR [rip+0x2e6b],0x1        # 404038 <__TMC_END__>
  4011cd:	5d                   	pop    rbp
  4011ce:	c3                   	ret
  4011cf:	90                   	nop
  4011d0:	c3                   	ret
...
00000000004011f0 <probe(int)>:
  4011f0:	f3 0f 1e fa          	endbr64
  4011f4:	41 57                	push   r15
  4011f6:	41 56                	push   r14
  4011f8:	4c 8d 35 05 0e 00 00 	lea    r14,[rip+0xe05]        # 402004 <_IO_stdin_used+0x4>
  4011ff:	41 55                	push   r13
  401201:	4c 8d 2d fe 0d 00 00 	lea    r13,[rip+0xdfe]        # 402006 <_IO_stdin_used+0x6>
  ...
  401223:	0f 84 87 00 00 00    	je     4012b0 <probe(int)+0xc0>
  ...
  401255:	74 41                	je     401298 <probe(int)+0xa8>
  401257:	48 85 c0             	test   rax,rax
  40125a:	74 08                	je     401264 <probe(int)+0x74>
  ...
  401275:	74 08                	je     40127f <probe(int)+0x8f>
