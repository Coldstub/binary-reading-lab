...
compiler_delta/gcc_O2/linkedlist_gcc_O2_stripped:     file format elf64-x86-64
...
0000000000401000 <.init>:
  ...
  401008:	48 8b 05 d1 2f 00 00 	mov    rax,QWORD PTR [rip+0x2fd1]        # 403fe0 <exit@plt+0x2ee0>
...
0000000000401020 <.plt>:
  401020:	ff 35 ca 2f 00 00    	push   QWORD PTR [rip+0x2fca]        # 403ff0 <exit@plt+0x2ef0>
  401026:	ff 25 cc 2f 00 00    	jmp    QWORD PTR [rip+0x2fcc]        # 403ff8 <exit@plt+0x2ef8>
...
0000000000401110 <.text>:
  ...
  401212:	e8 b9 01 00 00       	call   4013d0 <exit@plt+0x2d0>
  401217:	48 89 de             	mov    rsi,rbx
  40121a:	48 89 ef             	mov    rdi,rbp
  40121d:	e8 ae 01 00 00       	call   4013d0 <exit@plt+0x2d0>
  401222:	48 89 df             	mov    rdi,rbx
  401225:	e8 76 02 00 00       	call   4014a0 <exit@plt+0x3a0>
  40122a:	48 89 df             	mov    rdi,rbx
  40122d:	e8 5e 03 00 00       	call   401590 <exit@plt+0x490>
  ...
  40125f:	ff 15 73 2d 00 00    	call   QWORD PTR [rip+0x2d73]        # 403fd8 <exit@plt+0x2ed8>
  401265:	f4                   	hlt
  ...
  4012f4:	80 3d 4d 2d 00 00 00 	cmp    BYTE PTR [rip+0x2d4d],0x0        # 404048 <exit@plt+0x2f48>
  4012fb:	75 13                	jne    401310 <exit@plt+0x210>
  4012fd:	55                   	push   rbp
  4012fe:	48 89 e5             	mov    rbp,rsp
  401301:	e8 7a ff ff ff       	call   401280 <exit@plt+0x180>
  401306:	c6 05 3b 2d 00 00 01 	mov    BYTE PTR [rip+0x2d3b],0x1        # 404048 <exit@plt+0x2f48>
  40130d:	5d                   	pop    rbp
  40130e:	c3                   	ret
  40130f:	90                   	nop
  401310:	c3                   	ret
  ...
  4013b8:	48 8d 3d 4d 0c 00 00 	lea    rdi,[rip+0xc4d]        # 40200c <exit@plt+0xf0c>
  ...
  4013e7:	eb 5b                	jmp    401444 <exit@plt+0x344>
  ...
  4013f7:	74 4b                	je     401444 <exit@plt+0x344>
  ...
  40140b:	74 6b                	je     401478 <exit@plt+0x378>
  40140d:	48 8b 53 10          	mov    rdx,QWORD PTR [rbx+0x10]
  401411:	48 8d 3d 3c 0c 00 00 	lea    rdi,[rip+0xc3c]        # 402054 <exit@plt+0xf54>
  ...
  401438:	48 8d 3d 41 0c 00 00 	lea    rdi,[rip+0xc41]        # 402080 <exit@plt+0xf80>
  ...
  40145a:	74 36                	je     401492 <exit@plt+0x392>
  40145c:	48 c7 40 08 00 00 00 	mov    QWORD PTR [rax+0x8],0x0
  401463:	00 
  401464:	48 8d 3d b7 0b 00 00 	lea    rdi,[rip+0xbb7]        # 402022 <exit@plt+0xf22>
  40146b:	e8 50 fc ff ff       	call   4010c0 <puts@plt>
  401470:	eb b3                	jmp    401425 <exit@plt+0x325>
  401472:	66 0f 1f 44 00 00    	nop    WORD PTR [rax+rax*1+0x0]
  401478:	48 c7 40 10 00 00 00 	mov    QWORD PTR [rax+0x10],0x0
  40147f:	00 
  401480:	48 8d 3d b5 0b 00 00 	lea    rdi,[rip+0xbb5]        # 40203c <exit@plt+0xf3c>
  401487:	48 89 46 08          	mov    QWORD PTR [rsi+0x8],rax
  40148b:	e8 30 fc ff ff       	call   4010c0 <puts@plt>
  401490:	eb 93                	jmp    401425 <exit@plt+0x325>
  401492:	48 c7 46 08 00 00 00 	mov    QWORD PTR [rsi+0x8],0x0
  401499:	00 
  40149a:	eb c8                	jmp    401464 <exit@plt+0x364>
  40149c:	0f 1f 40 00          	nop    DWORD PTR [rax+0x0]
  4014a0:	f3 0f 1e fa          	endbr64
  4014a4:	41 56                	push   r14
  4014a6:	4c 8d 35 33 0c 00 00 	lea    r14,[rip+0xc33]        # 4020e0 <exit@plt+0xfe0>
  4014ad:	41 55                	push   r13
  4014af:	4c 8d 2d 6a 0c 00 00 	lea    r13,[rip+0xc6a]        # 402120 <exit@plt+0x1020>
  4014b6:	41 54                	push   r12
  4014b8:	4c 8d 25 a1 0c 00 00 	lea    r12,[rip+0xca1]        # 402160 <exit@plt+0x1060>
  4014bf:	55                   	push   rbp
  ...
  4014cd:	75 34                	jne    401503 <exit@plt+0x403>
  4014cf:	e9 9c 00 00 00       	jmp    401570 <exit@plt+0x470>
  4014d4:	0f 1f 40 00          	nop    DWORD PTR [rax+0x0]
  4014d8:	48 39 c3             	cmp    rbx,rax
  4014db:	74 53                	je     401530 <exit@plt+0x430>
  ...
  4014fd:	74 49                	je     401548 <exit@plt+0x448>
  ...
  401517:	75 bf                	jne    4014d8 <exit@plt+0x3d8>
  401519:	48 39 c3             	cmp    rbx,rax
  40151c:	74 3a                	je     401558 <exit@plt+0x458>
  ...
  40152d:	eb bd                	jmp    4014ec <exit@plt+0x3ec>
  40152f:	90                   	nop
  ...
  40153f:	eb ab                	jmp    4014ec <exit@plt+0x3ec>
  ...
  401558:	48 8d 35 41 0b 00 00 	lea    rsi,[rip+0xb41]        # 4020a0 <exit@plt+0xfa0>
  40155f:	bf 02 00 00 00       	mov    edi,0x2
  401564:	31 c0                	xor    eax,eax
  401566:	e8 75 fb ff ff       	call   4010e0 <__printf_chk@plt>
  40156b:	e9 7c ff ff ff       	jmp    4014ec <exit@plt+0x3ec>
  401570:	5b                   	pop    rbx
  401571:	48 8d 3d f2 0a 00 00 	lea    rdi,[rip+0xaf2]        # 40206a <exit@plt+0xf6a>
  401578:	5d                   	pop    rbp
  ...
  401597:	74 4f                	je     4015e8 <exit@plt+0x4e8>
  401599:	55                   	push   rbp
  ...
  4015a8:	74 26                	je     4015d0 <exit@plt+0x4d0>
  ...
  4015bf:	75 ef                	jne    4015b0 <exit@plt+0x4b0>
  ...
  4015d4:	48 8d 3d c5 0b 00 00 	lea    rdi,[rip+0xbc5]        # 4021a0 <exit@plt+0x10a0>
  4015db:	5b                   	pop    rbx
  4015dc:	5d                   	pop    rbp
  4015dd:	e9 de fa ff ff       	jmp    4010c0 <puts@plt>
  4015e2:	66 0f 1f 44 00 00    	nop    WORD PTR [rax+rax*1+0x0]
  4015e8:	48 8d 3d b1 0b 00 00 	lea    rdi,[rip+0xbb1]        # 4021a0 <exit@plt+0x10a0>
  4015ef:	e9 cc fa ff ff       	jmp    4010c0 <puts@plt>

Disassembly of section .fini:

00000000004015f4 <.fini>:
